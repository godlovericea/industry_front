<template>
    <div id="map">
        ...
        <div class="rightBox">
            ...
            <div class="leftheaderBox">
                <p class="headerTitle" v-if="companyType === 1">
                    人工智能应用场景
                </p>
                <p class="headerTitle" v-if="companyType === 2">
                    光电技术应用场景
                </p>
                <p class="headerTitle" v-if="companyType === 3">
                    生物医药应用场景
                </p>
